...
namespace TzarGames.GameCore.Abilities.Generated
{
	...
	[BurstCompile]
	public struct PowerattackabilityClient_20_AbilityJob : IJobChunk
	{
	...
	static class PowerattackabilityClient_20_Initializator
	{
		static System.Type jobType = typeof(PowerattackabilityClient_20_AbilityJob);

		[UnityEngine.RuntimeInitializeOnLoadMethod]
		static void initialize()
		{
			if(PowerattackabilityClient_20_AbilityJob.ActionCallWrapper.ExecFunction.Data.IsCreated == false)
			{
				PowerattackabilityClient_20_AbilityJob.ActionCallWrapper.ExecFunction.Data = BurstCompiler.CompileFunctionPointer<ActionCaller.ActionCallDelegate>(PowerattackabilityClient_20_AbilityJob.ActionCallWrapper.ActionCallFunction);
			}
		...
		{
			return world.CreateSystem<PowerattackabilityClient_20_System>();
		}

	}
	[BurstCompile]
	[DisableAutoCreation]
	partial struct PowerattackabilityClient_20_System : ISystem
	{
		EntityQuery query;
		PowerattackabilityClient_20_AbilityJob job;
		...
		PowerattackabilityClient_20_AbilityJob createJob(ref SystemState state)
		{
			var job = new PowerattackabilityClient_20_AbilityJob();
