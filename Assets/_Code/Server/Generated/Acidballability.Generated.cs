...
namespace TzarGames.GameCore.Abilities.Generated
{
	...
	[BurstCompile]
	public struct Acidballability_155_AbilityJob : IJobChunk
	{
	...
	static class Acidballability_155_Initializator
	{
		static System.Type jobType = typeof(Acidballability_155_AbilityJob);

		[UnityEngine.RuntimeInitializeOnLoadMethod]
		static void initialize()
		{
			if(Acidballability_155_AbilityJob.ActionCallWrapper.ExecFunction.Data.IsCreated == false)
			{
				Acidballability_155_AbilityJob.ActionCallWrapper.ExecFunction.Data = BurstCompiler.CompileFunctionPointer<ActionCaller.ActionCallDelegate>(Acidballability_155_AbilityJob.ActionCallWrapper.ActionCallFunction);
			}
		...
		{
			return world.CreateSystem<Acidballability_155_System>();
		}

	}
	[BurstCompile]
	[DisableAutoCreation]
	partial struct Acidballability_155_System : ISystem
	{
		EntityQuery query;
		Acidballability_155_AbilityJob job;
		...
		Acidballability_155_AbilityJob createJob(ref SystemState state)
		{
			var job = new Acidballability_155_AbilityJob();
