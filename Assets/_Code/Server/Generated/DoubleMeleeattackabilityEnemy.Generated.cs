...
namespace TzarGames.GameCore.Abilities.Generated
{
	...
	[BurstCompile]
	public struct DoubleMeleeattackabilityEnemy_166_AbilityJob : IJobChunk
	{
	...
	static class DoubleMeleeattackabilityEnemy_166_Initializator
	{
		static System.Type jobType = typeof(DoubleMeleeattackabilityEnemy_166_AbilityJob);

		[UnityEngine.RuntimeInitializeOnLoadMethod]
		static void initialize()
		{
			if(DoubleMeleeattackabilityEnemy_166_AbilityJob.ActionCallWrapper.ExecFunction.Data.IsCreated == false)
			{
				DoubleMeleeattackabilityEnemy_166_AbilityJob.ActionCallWrapper.ExecFunction.Data = BurstCompiler.CompileFunctionPointer<ActionCaller.ActionCallDelegate>(DoubleMeleeattackabilityEnemy_166_AbilityJob.ActionCallWrapper.ActionCallFunction);
			}
		...
		{
			return world.CreateSystem<DoubleMeleeattackabilityEnemy_166_System>();
		}

	}
	[BurstCompile]
	[DisableAutoCreation]
	partial struct DoubleMeleeattackabilityEnemy_166_System : ISystem
	{
		EntityQuery query;
		DoubleMeleeattackabilityEnemy_166_AbilityJob job;
		...
		DoubleMeleeattackabilityEnemy_166_AbilityJob createJob(ref SystemState state)
		{
			var job = new DoubleMeleeattackabilityEnemy_166_AbilityJob();
