...
namespace TzarGames.GameCore.Abilities.Generated
{
	...
	[BurstCompile]
	public struct Speedstrikeability_177_AbilityJob : IJobChunk
	{
	...
	static class Speedstrikeability_177_Initializator
	{
		static System.Type jobType = typeof(Speedstrikeability_177_AbilityJob);

		[UnityEngine.RuntimeInitializeOnLoadMethod]
		static void initialize()
		{
			if(Speedstrikeability_177_AbilityJob.ActionCallWrapper.ExecFunction.Data.IsCreated == false)
			{
				Speedstrikeability_177_AbilityJob.ActionCallWrapper.ExecFunction.Data = BurstCompiler.CompileFunctionPointer<ActionCaller.ActionCallDelegate>(Speedstrikeability_177_AbilityJob.ActionCallWrapper.ActionCallFunction);
			}
		...
		{
			return world.CreateSystem<Speedstrikeability_177_System>();
		}

	}
	[BurstCompile]
	[DisableAutoCreation]
	partial struct Speedstrikeability_177_System : ISystem
	{
		EntityQuery query;
		Speedstrikeability_177_AbilityJob job;
		...
		Speedstrikeability_177_AbilityJob createJob(ref SystemState state)
		{
			var job = new Speedstrikeability_177_AbilityJob();
